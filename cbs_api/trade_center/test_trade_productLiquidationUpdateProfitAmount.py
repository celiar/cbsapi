...
class productLiquidationUpdateProfitAmount(unittest.TestCase):
    '''•产品清算修改收益金额接口'''

    def test_01(self):
        '''正常测试'''
        url = ip_tc + "/trade/productLiquidationUpdateProfitAmount"
        headers = {'Content-Type': 'application/json'}
        data = {
            "newProfitAmount": 0.00,
            "tradeId": 234,
            "beforeProfitAmount": 0.00,
            "tradeAmount": 0.00
        }
