...
class contractSendBack(unittest.TestCase):
    '''•合同寄回接口'''

    def test_01(self):
        '''正常测试'''
        url = ip_tc + "/trade/contractSendBack"
        headers = {'Content-Type': 'application/json'}
        data =  {
            "branchSendTime":1557130278,
            "trunkRecipients":"tom",
            "trunkReceiveAddress":"lucy",
            "branchSendFirm":"邮政EMS",
            "branchSendOrderNo":"mc2902902922",
            "contractUserState":1,
            "contractSendState":3,
            "branchSender":"jinwei",
            "id":123
